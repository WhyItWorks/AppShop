@extends('layouts.app') @section('title',config('app.name'). ' | Listado de productos') @section('body-class','product-page')
@section('content')
							...
							<tr>
								...
								<td class="td-actions text-right">
									...
									<form action="{{ url('/admin/products/'. $product->id ) }}" method="post">
										...
										<a href="{{ url('/products/' . $product->id) }}" target="_blanc" rel="tooltip" title="Ver producto" class="btn btn-info btn-simple btn-xs">
